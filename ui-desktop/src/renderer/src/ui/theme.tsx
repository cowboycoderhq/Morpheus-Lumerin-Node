...
//   • aurora  — the high-contrast look: cyan-on-void, monospace, glass,
//               glow, status orbs.
...
//
// Binding spec for the aurora values. Notably:
...
// ============================================================================
// AURORA — the high-contrast look. The values below are one fixed palette;
// tune them as a set or not at all, since every surface reads these tokens.
// ============================================================================
const auroraBrand = '#6fd6ff'; // signature cyan — accent / actions
...
const aurora = {
  ...
  colors: {
    ...
    // Semantic — success DISTINCT from brand (see the binding spec); always icon+label paired
    ...
    // Glass / chrome surfaces — NEVER used on money surfaces (see the binding spec)
    ...
    // Money surfaces (see the binding spec) — solid, opaque, max-contrast. No glass/glow.
