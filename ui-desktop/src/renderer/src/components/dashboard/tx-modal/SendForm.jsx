...
// Money surface (see the binding spec): the amount being sent — mono/tabular, solid background.
...
// Money surface (see the binding spec): the estimated fee amount — mono/tabular.
...
// Money surface (see the binding spec): the destination address — mono/tabular, solid bg.
...
// Money surface (see the binding spec): the confirmation is the last thing between the user and an
