...
// Money surface (see the binding spec): the amount just sent — mono/tabular.
...
// Money surface (see the binding spec): the destination address inline in the confirmation
