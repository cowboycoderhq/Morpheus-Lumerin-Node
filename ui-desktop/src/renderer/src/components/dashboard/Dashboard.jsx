...
// still honors reduced-motion below (see the binding spec).
...
// Money surface (see the binding spec): shows the wallet address — solid/opaque, mono, no
...
// Money surface (see the binding spec): live coin balances — solid/opaque background, no
...
// Money surface (see the binding spec): staked balance is a live fund figure.
