...
//   block run to its end and closed a few seconds late returned 0.06% and
//   held the rest. There is no "close it late and it is free" path; that was
...
//   because none of the session lies inside the closing day (three closes,
//   hold delta exactly 0). It does not revert.
