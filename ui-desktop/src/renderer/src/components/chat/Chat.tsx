...
export const Chat = (props: ChatProps) => {
  ...
  // A provider registers an endpoint (e.g. "example.com:3333"); its hostname is
  ...
  const closeSession = async (sessionId: string) => {
    ...
    // paid the early-close penalty (a live session lost part of the stake to exactly this)
    // AND left the run restaking regardless.
