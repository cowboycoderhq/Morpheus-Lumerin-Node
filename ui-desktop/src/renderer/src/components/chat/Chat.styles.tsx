...
export const ChatIntroButton = styled.button.attrs({ type: 'button' })`
  ...
  border: 1.5px solid rgba(111, 214, 255, 0.85);
  box-shadow:
    0 0 12px rgba(111, 214, 255, 0.45),
    inset 0 0 8px rgba(111, 214, 255, 0.18);
  transition:
  ...
  &:hover:not([disabled]) {
    ...
    box-shadow:
      0 0 18px rgba(111, 214, 255, 0.65),
      inset 0 0 10px rgba(111, 214, 255, 0.28);
  }
...
export const Bubble = styled.div<{ $user?: boolean }>`
  ...
  background: ${(p) =>
    p.$user ? 'rgba(111, 214, 255, 0.10)' : p.theme.colors.glassSurface};
  border: 1px solid
    ${(p) =>
      p.$user ? 'rgba(111, 214, 255, 0.35)' : p.theme.colors.glassBorder};
`;
...
export const ModelGlyph = styled.div<{ $thinking?: boolean }>`
  ...
  font-size: 1.8rem;
  line-height: 1;
  text-shadow: 0 0 8px rgba(94, 208, 255, 0.7);
  ...
  &::before {
    ...
    inset: 0;
    border-radius: ${(p) => p.theme.radii.pill};
    border: 2px solid rgba(94, 208, 255, 0.9);
  ...
  &::after {
    ...
    inset: 0.55rem;
    border-radius: ${(p) => p.theme.radii.pill};
    border: 1px solid rgba(94, 208, 255, 0.45);
    ${(p) =>
      p.$thinking &&
      css`
...
export const LiveDot = styled.span`
  ...
  box-shadow: 0 0 8px rgba(89, 227, 167, 0.8);
`;
...
export const SecureBadge = styled.span`
  ...
  background: rgba(17, 180, 191, 0.14);
  cursor: default;
`;
...
export const PromptCard = styled.button`
  ...
  &:hover {
    ...
    border-color: rgba(94, 208, 255, 0.35);
...
export const Composer = styled.div<{ $focused?: boolean }>`
  ...
  border-radius: ${(p) => p.theme.radii.lg};
  box-shadow: ${(p) =>
    p.$focused ? '0 0 0 3px rgba(94, 208, 255, 0.12)' : 'none'};
...
export const MessageOrb = styled.div<{ $thinking?: boolean }>`
  ...
  &::before {
    ...
    inset: 0;
    border-radius: ${(p) => p.theme.radii.pill};
    border: 2px solid rgba(94, 208, 255, 0.85);
  }
