...
// Restyling only. Two changes were considered and rejected: collapsing the two
// consents into ONE checkbox that sets both flags, and dropping the
...
// consents and the terms text stay; only the chrome changes.
