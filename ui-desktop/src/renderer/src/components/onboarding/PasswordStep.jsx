...
// alone makes it look like the live suggestions were dropped — they were not,
// they moved into the meter, where they sit beside the bar instead of floating
// over the callout. Two further defects are fixed below: "on this Mac" (false
// on the win/linux builds) and a cyan hover literal that never swapped.
