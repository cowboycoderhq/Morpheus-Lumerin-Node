...
// be lying if it claimed to be "Step 3 of 4" — and keeps `onBack`, so a
// user who reaches this branch by mistake can still leave it. That button is
// this file's entire delta: there is no restyling here, only the button to keep.
