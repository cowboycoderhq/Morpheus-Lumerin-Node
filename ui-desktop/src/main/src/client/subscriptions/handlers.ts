...
export const redactSecretsInText = (s: unknown): string =>
  String(s ?? '')
    ...
    // A BIP39 mnemonic: 12-24 consecutive short lowercase words. Deliberately
    // greedy for a LOG backstop — over-redacting a run of words is fine; leaking
    // a seed is not. (The precise per-value redaction elsewhere is the primary.)
