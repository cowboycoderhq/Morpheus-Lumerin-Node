...
// RELAUNCH REPRO: no live runs (keep-alive refs die with the process); the only
// claim on these paid sessions is the DURABLE record from GET /v1/chats.
// ORIGINAL: Chat remounts (Wallet tab -> back) while TWO rolling runs are live.
...
const P1 = '0x82463AfE8749d2C8c518Ce28b6d4F289faAA9235';
...
// A RELAUNCH: no runs, no in-memory claims. Keep-alive state lives in refs and
// dies with the process, so the durable record is the only thing standing
// between these paid sessions and adoption by a fresh chat.
...
const props = {
  ...
  client: {
    ...
    getChatHistoryTitles: async () => [
      { chatId: 'chatA', title: 'Bound A', modelId: MODEL_ID, createdAt: now - 100, isLocal: false, sessionId: '0xsessA' },
      { chatId: 'chatB', title: 'Bound B', modelId: MODEL_ID, createdAt: now - 100, isLocal: false, sessionId: '0xsessB' },
    ],
