...
const keepAliveValue = {
  statuses: {
    ...
    chatB: { running: false, index: 1, total: 10, targetEndTime: now + 3000, modelId: MODEL_ID, chatId: 'chatB' },
  },
...
const props = {
  ...
  getSessionsByUser: async () => [SESS_FREE, SESS_A, SESS_B],
...
queryClient.setQueryData(queryKeys.sessions(props.address), [SESS_FREE, SESS_A, SESS_B]);
