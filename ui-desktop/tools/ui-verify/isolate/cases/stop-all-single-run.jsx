...
// SINGLE RUN, and the user is IN that chat: the stop-all must not appear.
// ORIGINAL: rolling run on chat A is LIVE and currently serving block b5. The chat
...
const B5 = mk('0xb5', 280, false);   // the run's LIVE block
...
const keepAliveValue = {
  ...
  sessionsByChat: { chatA: B5 },
  sessionIdsByChat: { chatA: ['0xb3', '0xb4', '0xb5'] },
  runningCount: 1,
