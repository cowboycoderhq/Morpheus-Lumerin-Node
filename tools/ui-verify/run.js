...
// assertions), captures motion-frozen screenshots, and writes an evidence file
// beside the screenshots.
//
// v2: v1 proved what the UI looks like, never
// what it does — the four hand-found failures were all in the blind spot.
//
...
//                     [--allow-net] [--selftest]
//
// Evidence: a markdown report per run, plus screenshots beside it.
...
try {
  ...
  for (const route of targets) {
    ...
    // (a later finding): an auth wall or wrong screen passes liveness and
