...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/structs.DelegatedPoolRes"
                        }
                    }
                }
            }
        ...
        "/v1/audio/transcriptions": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Output content type (e.g., both, text_only)",
                        "name": "output_content",
                        "in": "formData"
                    },
                    {
    ...
    "definitions": {
        ...
        "structs.DelegatedPoolRes": {
            "type": "object",
            "properties": {
                "availableToStake": {
                    "description": "AvailableToStake is what the router's wallet can stake from its delegated\npool right now. Matured day-locks count as available: the contract\nrecycles them automatically on the next pool draw.",
                    "type": "integer",
                    "example": 100000000
                },
                "freeBalance": {
                    "description": "FreeBalance is pool MOR not locked in sessions or day-locks.",
                    "type": "integer",
                    "example": 100000000
                },
                "funderCount": {
                    "description": "FunderCount is the number of cold wallets with an active grant.",
                    "type": "integer",
                    "example": 5
                },
                "holdCount": {
                    "description": "HoldCount is the number of day-lock buckets not yet recycled.",
                    "type": "integer",
                    "example": 1
                },
                "lockedBalance": {
                    "description": "LockedBalance is pool MOR locked in open sessions or maturing day-locks.",
                    "type": "integer",
                    "example": 100000000
                },
                "pendingWithdrawalsTotal": {
                    "description": "PendingWithdrawalsTotal is funder withdrawal volume queued for service.",
                    "type": "integer",
                    "example": 0
                }
            }
