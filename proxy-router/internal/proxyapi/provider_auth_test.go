...
// The address fixtures in this file are synthetic: none has code, a nonce
// or a balance on Base, Ethereum, Arbitrum One or either Sepolia. They
// exist to exercise the resolver's branches, and belong to no account.
func TestAuthorizedSigner_EOAReturnsSelf(t *testing.T) {
	provider := common.HexToAddress("0x462198870c58a805643de4d1EbF305135F3dF071")
