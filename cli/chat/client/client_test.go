...
// TestListSessionsOrderQueryString covers the first of two defects.
// The pre-pagination CLI sent no order parameter at all for
...
// newest-first results. A bare `listBlockchainSession`
