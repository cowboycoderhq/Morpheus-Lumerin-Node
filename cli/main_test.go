...
// an earlier commit (--offset/--limit/--order on listBlockchainSession), plus
// the follow-up fixes to the same three flags:
...
//     invocation behaviour deliberately, while still
...
// TestResolveOrder covers defect 1: a bare
// invocation of `listBlockchainSession` (no --order flag) must return
...
// TestBlockchainProvidersBidsRejectsNegativeOffset covers the second:
// validateOffset was applied in listBlockchainSessions but
