...
<Steps>
  <Step title="Have a backend model">
    Endpoint reachable from your proxy-router host, compatible with the `apiType` in `models-config.json` (e.g., for OpenAI: `http://my-model:8080/v1/chat/completions`).
  </Step>
