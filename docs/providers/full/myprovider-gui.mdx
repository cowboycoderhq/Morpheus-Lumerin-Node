...
7. After bidding, update `models-config.json` directly and restart, or delete the file and set `MODELS_CONFIG_CONTENT` again if needed.
...
| Craft the 5 SecretVM secrets (`MODELS_CONFIG_CONTENT` is one of the five) | Yes |
