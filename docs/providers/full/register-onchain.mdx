...
|------|-------------|---------|
| `providerMinStake` | `200000000000000000` (Base mainnet) · `200000000000000000` (Base Sepolia) | `0.2` MOR · `0.2` MOR |
| `modelMinStake` | `100000000000000000` (both) | `0.1` MOR |
| `marketplaceBidFee` | `300000000000000000` (Base mainnet) · `0` (Base Sepolia) | `0.3` MOR · `0` — Base Sepolia bids are free; owner-settable via `setMarketplaceBidFee`, read live with `getBidFee()` |
