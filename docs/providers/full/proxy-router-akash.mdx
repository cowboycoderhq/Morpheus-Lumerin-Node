...
<Steps>
  <Step title="Prepare the SDL">
    Download and customize [`docs/02.2-proxy-router-akash.yml`](https://github.com/MorpheusAIs/Morpheus-Lumerin-Node/blob/main/docs/02.2-proxy-router-akash.yml). Minimum proxy-router image version: `v3.0.0` — the pin used by the linked SDL itself (`docs/02.2-proxy-router-akash.yml:5`). Use a newer release tag for current features.
    Configure:
    - Wallet private key
