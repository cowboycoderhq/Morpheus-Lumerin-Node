...
stateDiagram-v2
  ...
  OnHold --> Swept: proxy-router StakeClaimer polls every 10 min and sweeps once releaseAt_ has passed
  Swept --> [*]: withdrawUserStakes submitted by your node; calling it yourself is optional
```
